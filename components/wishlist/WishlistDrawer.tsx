    ...
    <div className={isOpen ? "fixed inset-0 z-[60]" : "pointer-events-none fixed inset-0 z-[60]"}>
      ...
      >
        <div className="flex items-center justify-between border-b border-border-sand px-6 py-5">
          <h2 className="font-serif text-lg text-ink">Favoris ({items.length})</h2>
          <button
            type="button"
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center gap-3 py-16 text-center">
              <Heart className="h-8 w-8 text-[#8a7c6c]" strokeWidth={1.4} aria-hidden="true" />
                ...
                <li key={item.productId} className="flex gap-4">
                  ...
                  <div className="flex flex-1 flex-col">
                    ...
                    <button
                      ...
                      className="mt-2 flex w-fit cursor-pointer items-center gap-1.5 rounded-full border border-border-sand px-3 py-1.5 text-[11px] tracking-wider text-ink uppercase transition-colors duration-200 hover:border-brown hover:text-brown"
                    >
