    ...
    <div ref={scopeRef} className="bg-cream px-4 py-16 sm:px-6 sm:py-24">
      <div className="mx-auto max-w-[1320px]">
        <div className="text-center">
          ...
          >
            La{" "}
            <em className="font-light text-brown italic underline decoration-brown/60 underline-offset-4">
              qualité
            </em>
            , au cœur
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {COMMITMENTS.map(({ icon: Icon, title, description, dark }) => (
            <div
              ...
              data-reveal
              className={cn(
                "relative flex flex-col items-center overflow-hidden rounded-2xl border px-6 py-8 text-center transition-transform duration-300 hover:-translate-y-1",
                dark
            ...
            >
              <Icon
                className={cn(
                  "pointer-events-none absolute -right-5 -bottom-5 h-28 w-28 -rotate-12",
                  dark ? "text-gold/10" : "text-brown/10",
                )}
                strokeWidth={1}
                aria-hidden="true"
              />
              <div className="relative z-10 flex flex-col items-center">
                ...
                <h3 className="mt-4 font-serif text-lg font-bold tracking-[0.04em] uppercase">
                  {title}
                </h3>
                <span
                  className={cn(
