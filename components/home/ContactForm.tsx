...
export function ContactForm() {
  ...
  return (
    <div
      id="footer-contact"
      className="relative scroll-mt-24 overflow-hidden bg-cream px-4 py-16 sm:px-6 sm:py-24"
    >
      ...
      <div ref={scopeRef} className="relative mx-auto max-w-4xl">
        <div
          data-reveal
          className="mb-3 text-xs tracking-[0.2em] text-brown uppercase"
        >
          / Contact
        </div>
        <h2
          data-reveal
          className="mb-14 font-serif text-[34px] leading-tight font-bold text-ink sm:text-[48px]"
        >
        ...
        <form onSubmit={handleSubmit}>
          <div
            data-reveal
            className="flex flex-wrap items-end gap-x-3 gap-y-2 text-lg text-ink sm:text-xl"
          >
          ...
          <div
            data-reveal
            className="mt-6 flex flex-wrap items-end gap-x-3 gap-y-2 text-lg text-ink sm:text-xl"
          >
          ...
          {CONTACT_INFO.map(({ icon: Icon, label, href }) => (
            ...
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white shadow-[0_2px_10px_rgba(0,0,0,0.06)] ring-1 ring-black/5 transition-all duration-300 group-hover:scale-110 group-hover:bg-gold/15 group-hover:shadow-[0_4px_14px_rgba(0,0,0,0.1)] group-hover:ring-gold/30">
                <Icon
                  className="h-4 w-4 text-brown transition-colors duration-200 group-hover:text-brown"
                  strokeWidth={1.5}
                  aria-hidden="true"
                />
              </div>
