    ...
    >
      ...
      <div className="grid gap-16 md:grid-cols-[1.2fr_1fr] md:items-start">
        <div className="relative w-full">
          ...
          <div
            data-reveal
            className="mt-12 flex items-center gap-5 rounded-full bg-[#3985e9]/20 p-4 pr-8 sm:p-5 sm:pr-10"
          >
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-white text-black">
              <Gift
                className="h-6 w-6 text-[#3985e9]"
                strokeWidth={1.5}
                aria-hidden="true"
              />
            </div>
            <div>
              <div className="text-[15px] font-bold tracking-wide text-[#3985e9] uppercase">
